...
(define (iterGrade)
  (begin
    ...
    (output (lambda () (equal? ((iter (- 0 10) (lambda (x) (* 3 x))) 1) (* 243 243))))
    (output (lambda () (equal? ((iter (- 0 10) (lambda (x) (* 4 x))) 1) (* 1024 1024))))
    (output (lambda () (equal? ((iter (- 0 10) (lambda (x) (- 1 x))) 1) 1)))))
